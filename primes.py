...
def Is_prime(Input):                    # negetive values and 0 and 1 are not primes.
    ...
    for div in range(2, Input):     # Chech if the Input is divisible to all the Input the less than it
